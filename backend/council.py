...
async def stage1_collect_responses(user_query: str, council_models: List[str] = None) -> List[Dict[str, Any]]:
    ...
    Args:
        ...
        council_models: Optional custom list of models
...
async def stage3_synthesize_final(
    ...
    Args:
        ...
        chairman_model: Optional custom chairman model
...
async def run_full_council(user_query: str, council_models: List[str] = None, chairman_model: str = None) -> Tuple[List, List, Dict, Dict]:
    """
